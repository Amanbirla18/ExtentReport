...
public class FreeCRMTest {
	...
	public void setExtent(){
		...
		extent = new ExtentReports("//C://ExtentReportss" + File.separator
				+ "FreeCRM.html", true);
		extent.addSystemInfo("Host Name", "Aman ");
		extent.addSystemInfo("User Name", "Birla");
	...
	public static String getScreenshot(WebDriver driver, String screenshotName) throws IOException{
        ...
        String dest = "C:\\ExtentReportss\\SC\\" + screenshotName+ dateName+ ".png";
